...
# CUDA_VISIBLE_DEVICES=0 python demo_real_franka_0809.py -o data/column_0714 -ri 192.168.0.168
# 引入viderecorder_new
import time
...
from diffusion_policy.real_world.real_env_franka_pro        import RealEnvFranka as RealEnv
    ...
    with SharedMemoryManager() as shm_manager:
        with KeystrokeCounter() as key_counter, \
                ...
                RealEnv(
                    ...
                    enable_depth  = False,                      # False True是否启用深度图像

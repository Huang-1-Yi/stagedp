...
python train_sim.py --config-name=robomimic_acdp_dpm_solver_2_2m task_name=stack_d1 n_demo=400
8月28日 
...
#### 无inner层       步长20 单步 2阶
CUDA_VISIBLE_DEVICES=1 HYDRA_FULL_ERROR=1 python train_sim.py --config-name=robomimic_acdp_dpm_solver++_0_2s task_name=stack_d1 n_demo=400
...
CUDA_VISIBLE_DEVICES=1 HYDRA_FULL_ERROR=1 python train_sim.py --config-name=robomimic_acdp_dpm_solver++_infer10 task_name=stack_d1 n_demo=400
